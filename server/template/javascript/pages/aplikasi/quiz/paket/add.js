...
class PageAplikasiQuizPaketSoalAdd extends React.Component{
  ...
  render() {     
    const {uploadProgress,uploadDisable,tingkatan,mapel,semester,bobotPilihan,bobotEssay,paketPilihan,paketEssay,dataPilihan,dataEssay,semesterPickPilihan,semesterPickEssay,semesterData,cariPilihan,cariEssay,totalDataPilihan,totalDataEssay,pagesPilihan,currPagePilihan,pagesEssay,currPageEssay,errorNama,errorBobot,errorBobotpilihan,errorBobotessay,errorPaketpilihan,errorPaketessay} = this.state; 
    ...
    <div className="konten"> 
        ...
        <div className="w-50 pa3">
          <div className="w-100 mb3">
            ...
            <InputText name="nama" placeholder="ketik nama paket soal disini" onChange={this.handleInputChange} errorMessage={errorNama}/>
          </div>
        </div>
        <div className="w-50 pa3">
          <div className="w-100 mb3">
  ...
  newPaket = () => {
    ...
    axios({
      ...
      data: formData
        ...
        {      
          toast.success("Data paket soal berhasil ditambahkan");                                     
          this.navigate(-1); 
        }
    }).catch(error => {                   
