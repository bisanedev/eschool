...
class PageSekolahKelas extends React.Component{
  ...
  render() {     
    ...
    const {data,totalData,pages,currPage,total,cari,selected,showDelete,showSingleDelete,singleData,showAdd,showEdit} = this.state;
    return (  
  ...
  /*--- Menambahkan data ---*/
  tambahkan = () => {
    console.log("tambahkan data post");
  }
  /*--- Edit Data ---*/
  onEdit = (data) => {
  ...
  singleDelete = (id) => {
    console.log("hapus delete "+id);
  }
  /*--- Hapus data ---*/
  multiDelete = () => {
    const {selected} = this.state;
    console.log("hapus DElete "+selected);
  }
  /*--- Logout ---*/
  logout = () => {   
