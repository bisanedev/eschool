        ...
        <div className="wrapDataExam bg-white tc br2">
            ...
            <div className="data">               
                ...
                <div className="footer">
                    <a className="flex ph2 link dim pointer primary" style={{fontSize:11}} href={props.onLihat}>
                        <i className="material-icons" style={{fontSize:"11px"}}>leaderboard</i>&nbsp; Lihat nilai
                    </a>
                    <a className="flex ph2 link dim pointer primary" style={{fontSize:11}} href={props.onEdit}>
