        ...
        <Table>
          <Table.Header>
            <div className="w-50 ph2">
              <button type="submit" className="pointer link dim br1 ba pa2 dib white bg-primary b--primary" onClick={() => this.setState({showAdd:true,errorTahun:""})}>
...
export default PageSekolahSemester;