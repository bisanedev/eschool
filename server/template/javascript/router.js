...
import PageAplikasiQuizExamEdit from './pages/aplikasi/quiz/exam/edit';
//---- Sekolah
    ...
    <HashRouter>
        <Routes>
          ...
          {/* aplikasi quiz */}
            ...
            <Route path="/aplikasi/quiz/exam/:tingkatID/:mapelID/:semesterID/:examID" element={<PrivateRoute komponen={PageAplikasiQuizExamEdit}/>}/>
          {/* sekolah variable  */}
